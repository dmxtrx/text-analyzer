...
**Цель проекта**: Создание инструмента для анализа текстовых данных, который может обрабатывать различные типы текста (отзывы пользователей, статьи, отрывки из книг) и предоставлять глубокий анализ, статистику и преобразования. 
